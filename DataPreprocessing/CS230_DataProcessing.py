...
MSASL_trainData = pd.read_json('data/msasl/MSASL_train.json')
MSASL_valData = pd.read_json('data/msasl/MSASL_val.json')
MSASL_testData = pd.read_json('data/msasl/MSASL_test.json')
MSASL_classes = pd.read_json('data/msasl/MSASL_classes.json')
